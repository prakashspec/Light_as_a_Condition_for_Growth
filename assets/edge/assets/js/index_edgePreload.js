...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "assets/js/jquery-1.7.1.min.js"},
    { load: "assets/js/edge.2.0.1.min.js"},
    { load: "assets/js/index_edge.js"},
    { load: "assets/js/index_edgeActions.js"}];
...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['431','285','62px','18px','auto','auto'],
